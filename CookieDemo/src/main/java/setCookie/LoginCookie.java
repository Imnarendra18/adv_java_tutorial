...
public class LoginCookie extends HttpServlet {
  ...
  if("admin".equals(username)&& "123".equals(password)) {
		...
		//create a cookie to store username
		//Cookie objectname = new Cookie("cookiesname", value);
		...
		response.sendRedirect("WelcomeCookie");
	        ...
	        out.println("<h1>invilid username and password <a herf='login.jsp'>try again<a><h/1>");
